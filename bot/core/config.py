...
- Ночью (23-6): совиный режим, Nürburgring по ночам лучше"""
    ...
    channel_prompt_suffix: str = (
        ...
        "ВАРИАТИВНОСТЬ ОТКРЫТИЙ (КРИТИЧЕСКИ ВАЖНО):\n"
        "НИКОГДА не начинай посты одинаково! Избегай повторяющихся форматов вроде:\n"
        "- '🔥 Мнение Маши (с сарказмом и BMW-экспертизой)'\n"
        "- '🔥 Мнение редакции'\n"
        "- Любого другого постоянного заголовка/открывашки\n"
        "Каждый пост должен начинаться УНИКАЛЬНО: с факта, вопроса, цитаты, ситуации, эмоции.\n"
        "Начинай СРАЗУ с сути — без формальных вводных.\n\n"
        ...
        "ПОМНИ: посты С ФОТО всегда предпочтительнее! Пиши текст так, чтобы он укладывался в 1024 символа — тогда к посту можно прикрепить до 10 реальных фото из новости. "
        "Только исключительный сверхценный контент публикуется без медиа (лимит 4096). "
    )
