...
class MashaBot:
    ...
    async def _post_news_item(self, news_item, mood, channel_id, channel_prompt):
        ...
        if is_english:
            translation_note = (
                "\n⚠️ ВНИМАНИЕ: новость на ИНОСТРАННОМ языке (английский/испанский/др). "
                "ОБЯЗАТЕЛЬНО ПЕРЕВЕДИ на русский язык и напиши пост ТОЛЬКО НА РУССКОМ. "
        ...
        prompt = (
            ...
            f"{translation_note}"
            f"КРИТИЧЕСКИ ВАЖНО: ПИШИ ТОЛЬКО НА РУССКОМ ЯЗЫКЕ. Запрещено писать на английском, испанском или других языках.\n"
            ...
            f"\n"
            f"СТИЛЬ:\n"
            f"- 600-900 символов, BMW M-разбор от редакции\n"
            f"- Эмодзи: \U0001f3ce\U0001f525\U0001f4aa\U0001f3c1\u2728\n"
            f"- Технические: двигатели, л.с., Н·м\n"
            f"- Женский род, ТОЛЬКО НА РУССКОМ, БЕЗ грамматических ошибок\n"
            f"- SEO: ключевые слова, хештеги, вопрос в конце\n"
            f"- НЕ ссылки, НЕ 'Маша:'"
        )
